...
private:
    ...
    void OnEditMachineDrawable(wxCommandEvent& event);
    ...
    ///MachineDrawable pointer
    std::shared_ptr<MachineDrawable> mMDraw;
...
public:
    ...
    ViewEdit(wxFrame* parent,std::wstring imagesDir);
