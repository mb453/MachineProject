...
{
private:
    ///MachineDrawable vector
    std::vector<std::shared_ptr<MachineDrawable>> mMDraw;
...
public:
    /**
     * Add a machine drawable to the picture
     * @param draw
     */
    void AddMachineDrawable(std::shared_ptr<MachineDrawable> draw){mMDraw.push_back(draw);}
    /**
     * Get the vector of machine drawables
     * @return
     */
    std::vector<std::shared_ptr<MachineDrawable>> GetMachineDrawable(){return mMDraw;}
