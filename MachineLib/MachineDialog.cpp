 ...
 * @param machine Machine we are editing
 */


MachineDialog::MachineDialog(wxWindow* parent, std::shared_ptr<Machine> machine) :
    wxDialog(parent, wxID_ANY, L"Machine Selection"), mMachine(machine)
{
    mMachineNumber = machine->GetMachineNumber();
 ...
 */
void MachineDialog::OnInitDialog(wxInitDialogEvent& event)
{
